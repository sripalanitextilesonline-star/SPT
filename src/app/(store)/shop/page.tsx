...
export const metadata: Metadata = {
  ...
  description:
    "Browse all silk, cotton, wedding and festive craft supplies at Sri Palani Textiles. Shop online with secure checkout and delivery across India.",
  alternates: {
    canonical: "/shop",
  },
  openGraph: {
    title: "Shop All Products | Sri Palani Textiles",
    description:
      "Browse all silk, cotton, wedding and festive craft supplies at Sri Palani Textiles.",
    url: "/shop",
  },
};
